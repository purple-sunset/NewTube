...
package com.hust.duc.gui.businessobjects;
...
import com.hust.duc.businessobjects.GetCommentThreads;
import com.hust.duc.businessobjects.YouTubeComment;
import com.hust.duc.businessobjects.YouTubeCommentThread;
...
public class CommentsAdapter extends BaseExpandableListAdapter {
	...
	private class CommentViewHolder {
		...
		protected void updateInfo(YouTubeComment comment, boolean isTopLevelComment, final int groupPosition) {
			...
			lp.width = (int) NewTubeApp.getDimension(isTopLevelComment  ?  R.dimen.top_level_comment_thumbnail_width  :  R.dimen.child_comment_thumbnail_width);
