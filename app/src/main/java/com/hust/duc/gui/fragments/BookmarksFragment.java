...
import com.hust.duc.gui.businessobjects.SimpleItemTouchHelperCallback;
import com.hust.duc.gui.businessobjects.bookmarksGridAdapter;
...
public class BookmarksFragment extends VideosGridFragment implements BookmarksDb.BookmarksDbListener {
	...
	protected String getFragmentName() {
		return NewTubeApp.getStr(R.string.bookmarks);
	}
