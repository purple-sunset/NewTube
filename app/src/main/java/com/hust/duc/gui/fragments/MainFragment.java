...
import com.hust.duc.gui.businessobjects.SubsAdapter;
...
public class MainFragment extends FragmentEx {
	...
	private GamingVideosFragment		gamingVideosFragment = null;
	...
	private class VideosPagerAdapter extends FragmentPagerAdapter {
		...
		public VideosPagerAdapter(FragmentManager fm) {
			...
			if (gamingVideosFragment == null)
				gamingVideosFragment = new GamingVideosFragment();
			...
			videoGridFragmentsList.add(gamingVideosFragment);
