...
import com.hust.duc.businessobjects.ValidateYouTubeAPIKey;
import com.hust.duc.businessobjects.VideoStream.VideoResolution;
 ...
 * {@link com.hust.duc.gui.activities.PreferencesActivity}
 */
public class PreferencesFragment extends PreferenceFragment implements SharedPreferences.OnSharedPreferenceChangeListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		websitePref.setSummary(BuildConfig.NEWTUBE_WEBSITE);
		websitePref.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
			@Override
			public boolean onPreferenceClick(Preference preference) {
				// view the app's website in a web browser
				Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(BuildConfig.NEWTUBE_WEBSITE));
	...
	private void displayCredits() {
		...
		webView.loadUrl(BuildConfig.NEWTUBE_WEBSITE_CREDITS);
