 ...
 * SkyTube application.
 */
public class NewTubeApp extends MultiDexApplication {

	/** SkyTube Application instance. */
	private static NewTubeApp newTubeApp = null;

	public static final String KEY_SUBSCRIPTIONS_LAST_UPDATED = "NewTubeApp.KEY_SUBSCRIPTIONS_LAST_UPDATED";
	...
	public static String getStr(int stringResId) {
		return newTubeApp.getString(stringResId);
	}
	...
	public static String[] getStringArray(int stringArrayResId) {
		return newTubeApp.getResources().getStringArray(stringArrayResId);
	}
	...
	public static SharedPreferences getPreferenceManager() {
		return PreferenceManager.getDefaultSharedPreferences(newTubeApp);
	}
	...
	public static float getDimension(int dimensionId) {
		return newTubeApp.getResources().getDimension(dimensionId);
	}
	...
	public static Context getContext() {
		return newTubeApp.getBaseContext();
	}
