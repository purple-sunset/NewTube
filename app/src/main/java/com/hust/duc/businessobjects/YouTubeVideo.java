...
import com.hust.duc.businessobjects.VideoStream.ParseStreamMetaData;
...
public class YouTubeVideo implements Serializable {
	...
	private static final Set<String> defaultPrefLanguages = new HashSet<>(NewTubeApp.getStringArrayAsList(R.array.languages_iso639_codes));
	...
	public YouTubeVideo(Video video) {
		...
		if (video.getStatistics() != null) {
			...
			this.viewsCount = String.format(NewTubeApp.getStr(R.string.views),
	...
	private void setIsLiveStream() {
		...
		if (duration.equals("0:00")) {
			isLiveStream = true;
			duration = NewTubeApp.getStr(R.string.LIVE);
	...
	private Set<String> getPreferredLanguages() {
		return NewTubeApp.getPreferenceManager().getStringSet(NewTubeApp.getStr(R.string.pref_key_preferred_languages), defaultPrefLanguages);
	}
